const prod = process.env.NODE_ENV !== "devSSR"

module.exports = function makeHtmlTemplate(
        reactDom,
        redux_state = null,
        cssChunks=["./css/start.css"],
        jsChunks=["./js/start.js"],
        title="wiz-battle-home") {
    let css = '';
    if (prod) 
        css = cssChunks.reduce((acc, chunk) => 
            acc + `<link rel="stylesheet" type="text/css" href="${chunk}" />`, ``);
